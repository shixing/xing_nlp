set PY=../py_att/run.py
set BLEU=../py/multi-bleu.perl
...
set DECODE_OUTPUT=../data/small/test.output.att.txt
...
python %PY% --mode BEAM_DECODE --model_dir %MODEL_DIR% ^
    ...
    --attention True --print_beam True --profile True --decode_output %DECODE_OUTPUT%
